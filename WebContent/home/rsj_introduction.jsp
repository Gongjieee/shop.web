				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="../images/ruishi1.jpg" title="pic" />
								</li>
								<li>
									<img src="../images/ruishi2.jpg" />
								</li>
								<li>
									<img src="../images/ruishi3.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="../images/ruishi1.jpg"><img src="../images/ruishi1.jpg" alt="细节展示放大镜特效" rel="../images/ruishi1.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../images/ruishi1.jpg" mid="../images/ruishi1.jpg" big="../images/ruishi1.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../images/ruishi2.jpg" mid="../images/ruishi2.jpg" big="../images/ruishi2.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../images/ruishi3.jpg" mid="../images/ruishi3.jpg" big="../images/ruishi3.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">99.00</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">999.00</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
								...
								<div class="iteminfo_freprice">
									<div class="am-form-content address">
										...
										<select data-am-selected>
											...
											<option value="b">洛阳市</option>
											<option value="b">南阳市</option>
											<option value="b">许昌市</option>
										</select>
										<select data-am-selected>
											<option value="a">中原区</option>
											<option value="b">二七区</option>
										</select>
									</div>
									<div class="pay-logis">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="../images/ruishi1.jpg" />
											<img src="../images/ruishi2.jpg" />
											<img src="../images/ruishi3.jpg" />
											<img src="../images/ruishi4.jpg" />
											<img src="../images/ruishi5.jpg" />
											<img src="../images/ruishi6.jpg" />
											<img src="../images/ruishi7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
